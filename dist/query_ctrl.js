        ...
        execute: function() {
            SqlQueryCtrl = (function (_super) {
                ...
                function SqlQueryCtrl($scope, $injector, templateSrv, $q, uiSegmentSrv) {
                    ...
                    this.queryBuilder = new query_builder_1.default(this.target, this.datasource.dbms, { matchOperators: this.matchOperators });
                    this.resultFormats = [
                ...
                */
                ...
                SqlQueryCtrl.prototype.getGroupByOptions = function (part) {
                    var _this = this;
